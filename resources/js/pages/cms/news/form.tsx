                            ...
                            <>
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        defaultValue={newsItem?.translations[locale]?.title ?? ''}
                                    />
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input
                                        ...
                                        defaultValue={newsItem?.translations[locale]?.slug ?? ''}
                                    />
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <textarea
                                        ...
                                        defaultValue={newsItem?.translations[locale]?.summary ?? ''}
                                ...
                                <RichTextEditor
                                    ...
                                    label="Content"
                                    initialHtml={newsItem?.translations[locale]?.content ?? null}
                                    fallbackBlocks={newsItem?.translations[locale]?.content_blocks ?? null}
                                />
                                ...
                                <div className="grid gap-2 md:grid-cols-2 md:gap-4">
                                    <div className="grid gap-2">
                                        ...
                                        <Input
                                            ...
                                            defaultValue={newsItem?.translations[locale]?.seo_title ?? ''}
                                        />
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <textarea
                                            ...
                                            defaultValue={newsItem?.translations[locale]?.seo_description ?? ''}
                                            className="border-input focus-visible:border-ring focus-visible:ring-ring/50 min-h-24 rounded-md border bg-transparent px-3 py-2 text-sm outline-none focus-visible:ring-[3px]"
                                        />
